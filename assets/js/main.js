...
const filterButton = document.querySelector('.lali');
...
let humay = document.querySelector('.humay')


if (
    humay.addEventListener("click", () => {
        filterButton.style.display = "block";
        humay.style.display = "none";
        let arr = [];
        list.push(arr);
        arr.forEach((item) => {
            item.sort();
